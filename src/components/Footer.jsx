    ...
    <footer className="bg-[#04351e] text-[#eebf1c] py-12 border-t-4 border-[#eebf1c]">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
        ...
        <div className="space-y-2 flex flex-col items-center md:items-start">
          ...
          <div className="mt-6 pt-2 w-1/2 md:w-full flex justify-center md:justify-start">
            <a 
              href="https://www.instagram.com/thegentlemenartistsarmoury?igsh=MXI1eG94Y2ozbm9vaQ==" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="inline-flex items-center gap-2 bg-[#eebf1c] text-[#04351e] px-4 py-2 rounded font-bold text-sm hover:bg-white hover:text-black transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
            >
